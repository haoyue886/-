	...
	<view class="page">
		...
		<view class="top-panel">
			...
			<view class="info">
				...
				<view class="row"><view class="link">初次到院就诊指南？</view></view>
			</view>
		</view>
...
export default {
	data() {
		return {
			...
			list1: [
				`${this.patientUrl}/swiper/swipers-1.jpg`,
				`${this.patientUrl}/swiper/swipers-2.jpg`,
				`${this.patientUrl}/swiper/swipers-3.jpg`,
				`${this.patientUrl}/swiper/swipers-4.jpg`
			],
